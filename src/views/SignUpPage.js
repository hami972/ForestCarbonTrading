            ...
            <section className="row g-0 pb-5" style={{backgroundImage: 'url(/images/forest2.png)', width: '100%'}}>
                ...
                <div style={{backgroundColor: "#fff",  marginTop: "70px" }} align="center">
                        <form style={{ backgroundColor: "#fff" }}>
                            ...
                            <div className="mb-3 mt-3 col-10">
                                <input type="number" className="form-control pb-3 pt-3" id="birthday" name="birthday" placeholder="Mã số doanh nghiệp: "  />
                            </div>
                            <div className="mb-3 mt-3 col-10">
                            ...
                            <div className="col-10 mb-3 mt-3">
                                <input type="text" className="form-control pb-3 pt-3" id="re-enter_password" name="re-enter_password" placeholder="Tỉnh/Thành phố: "  />
                            </div>
                           
                            <div className="col-10 pb-3 mb-4" />
                            <div className="col-10 mb-3 mt-4">
